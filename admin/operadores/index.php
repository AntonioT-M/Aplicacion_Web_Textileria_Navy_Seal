    ...
    <section class="wrapper">
        <div class="row mt">
            ...
            <div class="border-head" style="display: none;">
                <h3 style="color: black" id="tIndex">Operadores</h3>
            </div>
            <div class="border-head">
                <h3 id="title" style="color: black">Operadores</h3>
            </div>
            <section>
                ...
                <a href="excel.php"><button id="btnExcel" onclick="getExcel()" class="btn btn-primary" style="cursor: pointer;"><i id="faIconF" class="fa fa-file-excel-o"></i></button></a>
