    ...
    <section class="wrapper">
        <div class="row mt">
            ...
            <div class="border-head" style="display: none;">
                <h3 style="color: black" id="tIndex">Productos</h3>
            </div>
            <div class="border-head">
                <h3 id="title" style="color: black">Productos</h3>
            </div>
            <section>
                <button id="btnForm" class="btn btn-success" title="Nuevo" onclick="showForm()" style="cursor: pointer; <?php if($_SESSION['privilegios'] > 3){?> display: none; <?php }?>"><i id="faIconF" class="fa fa-plus"></i></button>
                <a href="excel.php"><button id="btnExcel" onclick="getExcel()" class="btn btn-primary" style="cursor: pointer; <?php if($_SESSION['privilegios'] > 3){?> display: none; <?php }?>"><i id="faIconF" class="fa fa-file-excel-o"></i></button></a>
                <a href="pdf.php"><button class="btn btn-danger" style="cursor: pointer; <?php if($_SESSION['privilegios'] > 3){?> display: none; <?php }?>"><i id="faIconF" class="fa fa-file-pdf-o"></i></button></a>
                <section>
