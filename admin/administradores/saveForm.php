<?php
    ...
    if($id){
        $object = Administradores::searchById($id);
    }else{
        $object = new Administradores();
    }
?>
    ...
    <div class="row">
        <div class="col-md-12" style="border: 1px solid black; box-shadow: 0px 0px 8px grey;">
            <form id="data" class="was-validated" style="margin-top: 2%; color: black;">
                <div class="row">
                <input type="hidden" name="idAdministrador" value="<?= $object->getIdAdministrador()?>">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group col-md-4 showA">
                        ...
                        <input class="form-control is-invalid" type="text" name="nombreAdmin" onchange="setNick();" id="nombre" placeholder="Nombre completo" style="text-transform: capitalize;" value="<?= $object->getNombreAdmin();?>" required>
                    </div>
                    <div class="form-group col-md-4 showA">
                        <label for="">Apellidos</label>
                        <input class="form-control" type="text" name="apellidosAdmin" onchange="setNick();" id="apellidos" placeholder="Apellido/s" style="text-transform: capitalize;" value="<?= $object->getApellidosAdmin();?>" required>
                    </div>
                    <div class="form-group col-md-4 showA">
                        <label for="">Cargo</label>
                        <select class="form-control" name="cargo" id="cargo" onchange="setPrivilegies();" required>
                            <option value="">Seleccione cargo</option>
                            <option value="TI" <?php if($object->getCargo() == "TI"){ echo 'Selected';}?>>TI</option>
                            <option value="Supervisor" <?php if($object->getCargo() == "Supervisor"){ echo 'Selected';}?>>Supervisor</option>
                            <option value="Programador" <?php if($object->getCargo() == "Programador"){ echo 'Selected';}?>>Programador</option>
                        </select>
                    </div>
                    <div class="col-sm-12">
                    <hr color="black" size="1" width="100%">
                    ...
                    <div class="form-group col-md-4 showB">
                        ...
                        <input class="form-control" type="text" placeholder="Nick" name="nickAdmin" id="nick" style="text-transform: uppercase;" value="<?= $object->getNickAdmin();?>" readonly required>
                    </div>
                    <div class="form-group col-md-4 showB">
                        <label for="">Password</label>
                        <input class="form-control" type="password" placeholder="********" name="passwordAdmin" value="<?= $object->getPasswordAdmin();?>" required>
                    </div>
                    <div class="form-group col-md-4 showB" style="display: none;">
                        <label for="">Privilegios</label>
                        <input class="form-control" type="hidden" id="privilegios" name="privilegiosAdmin" value="<?= $object->getPrivilegiosAdmin();?>" readonly required>
                    </div>
                    <div class="col-sm-12">
                    <hr color="black" size="1" width="100%">
                    </div>
